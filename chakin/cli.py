...
def chakin(ctx, instance, verbose, path=None):
    ...
    try:
        ...
        ctx.gi = get_instance(instance, offline=(current_ctx.invoked_subcommand in ['init', 'util']), no_reflect=(current_ctx.invoked_subcommand in ['analysis', 'organism']), full=(current_ctx.invoked_subcommand == 'load'))
    except TypeError:
        pass
