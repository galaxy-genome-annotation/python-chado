...
class ScriptBuilder(object):
    ...
    def __init__(self):
        ...
        # TODO: refactor
        self.obj = bg.ChadoInstance(dbhost="localhost", dbuser="postgres", dbpass="postgres", dbname="postgres", dbschema="public", dbport=5432)
    ...
    def is_galaxyinstance(self, obj):
        return str(type(obj)) == "<class 'chado.ChadoInstance'>"
